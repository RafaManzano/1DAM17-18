...
public class AlAtaquelEstiloCompadreP {
	...
	public static void main (String[] args) {
		...
		while (opcion != 0)  {
			...
			if (j1.getVida() <= 0) {	
				//El fallo es que lo tenias mal planteado, si escribias S volvia al bucle porque era la condicion que habias puesto (Linea 85), pero si ponias N el programa no sabia donde ir.
				//Asi queda mejor y ademas te da la opcion de elegir otro modo de juego
